...
<ul>
  ...
  <li><strong>Backend:</strong> Spring Boot, Spring Security, Spring Data JPA, REST APIs</li>
  <li><strong>Database:</strong> PostgreSQL</li>
  <li><strong>Testing:</strong> JUnit 5, Mockito</li>
  <li><strong>Tools:</strong> Git, Maven, IntelliJ IDEA, Postman, Figma</li>
</ul>
...
```
Java 17 · Spring Boot · Spring Security · Spring Data JPA · PostgreSQL · JUnit 5 · Mockito · Maven
```
...
<a href="https://leetcode.com/u/Sirions/" target="_blank">
